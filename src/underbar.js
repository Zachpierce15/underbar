(function() {
  ...
  _.uniq = function(array, isSorted, iterator) {
       ...
       var almostResult = Object.keys(obj);
       for (var key in almostResult) {
        result.push(Number(almostResult[key]))
       }
return result
  };
  ...
  _.reduce = function(collection, iterator, accumulator) {
      if (accumulator === undefined) {
        ...
        var newArray = collection.slice(1)
    for (var i = 0; i < newArray.length; i++) {

        if (newArray[i] === undefined){
          continue
        }else{
        var value = iterator(accumulator, newArray[i])
           accumulator = value;
         }
      }
      } else {
      for (var i = 0; i < collection.length; i++) {
        ...
        var value = iterator(accumulator, collection[i])
           accumulator = value;
         }
      }
    }
...
return accumulator 
  ...
  _.every = function(collection, iterator) {
    ...
    for (var i = 0; i < collection.length; i++) {
      if (iterator !== undefined && collection[i] === 0 && iterator(collection[0]) === true) {
       continue
      } else if (collection[i] === null || collection[i] === false || collection[i] === undefined || collection[i] === "" || collection[i] === '' || collection[i] == 0 || collection[i] === NaN){
           return false
